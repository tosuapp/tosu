...
export const calculateGrade = (mode: number, mods: number, h300: number, h100: number, h50: number, h0: number, acc: number): string => { //https://osu.ppy.sh/help/wiki/FAQ#grades
    const isHDFL = ((mods & OsuMods.Hidden) === OsuMods.Hidden) || ((mods & OsuMods.Flashlight) === OsuMods.Flashlight)
