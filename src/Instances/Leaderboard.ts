...
export class Leaderboard {
    ...
    private readLeaderPlayerStruct(base: number): [LeaderboardPlayer, boolean] {
        ...
        // [[Base + 0x20] + 0x1C] + 0x8
        const ModsXor1 = this.process.readInt(this.process.readInt(scoreboardEntry + 0x1C) + 0x8)
        // [[Base + 0x20] + 0x1C] + 0xC
        const ModsXor2 = this.process.readInt(this.process.readInt(scoreboardEntry + 0x1C) + 0xC)
        return [
            {
                // [Base + 0x8]
