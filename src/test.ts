...
const readMenu = async (process: Process) => {
	...
	return {
		...
		// [[Beatmap] + 0x18]
		Artist: process.readSharpString(
			process.readInt(process.readInt(beatmapAddr) + 0x18)
		),
		// [[Beatmap] + 0x1C]
		ArtistOriginal: process.readSharpString(
			process.readInt(process.readInt(beatmapAddr) + 0x1c)
		),
		// [[Beatmap] + 0x24]
		Title: process.readSharpString(
			process.readInt(process.readInt(beatmapAddr) + 0x24)
		),
		// [[Beatmap] + 0x28]
		TitleOriginal: process.readSharpString(
			process.readInt(process.readInt(beatmapAddr) + 0x28)
		),
		...
		//  [[Beatmap] + 0x64]
		AudioFilename: process.readSharpString(
			process.readInt(process.readInt(beatmapAddr) + 0x64)
		),
		//  [[Beatmap] + 0x68]
		BackgroundFilename: process.readSharpString(
			process.readInt(process.readInt(beatmapAddr) + 0x68)
		),
		//  [[Beatmap] + 0x78]
		Folder: process.readSharpString(
			process.readInt(process.readInt(beatmapAddr) + 0x78)
		),
		//  [[Beatmap] + 0x7C]
		Creator: process.readSharpString(
			process.readInt(process.readInt(beatmapAddr) + 0x7c)
		),
		//  [[Beatmap] + 0x80]
		Name: process.readSharpString(
			process.readInt(process.readInt(beatmapAddr) + 0x80)
		),
		//  [[Beatmap] + 0x94]
		Path: process.readSharpString(
			process.readInt(process.readInt(beatmapAddr) + 0x94)
		),
		//  [[Beatmap] + 0xB0]
		Difficulty: process.readSharpString(
			process.readInt(process.readInt(beatmapAddr) + 0xb0)
		),
		//  [Beatmap] + 0xCC
		...
		//  [[Beatmap] + 0x6C]
		MD5: process.readSharpString(
			process.readInt(process.readInt(beatmapAddr) + 0x6c)
		),
		//  [Beatmap] + 0xFC
	...
	while (true) {
		...
		const songsFolder = cherryProcess.readSharpString(
			cherryProcess.readInt(
				cherryProcess.readInt(cherryProcess.readInt(settingsClass + 0x8) + 0xb8) +
					0x4
			)
		);
