...
const convertMemoryPlayerToResult = (memoryPlayer: MemoryLeaderboardPlayer): LeaderboardPlayer => ({
...
export const buildResult = (service: DataRepo): ApiAnswer => {
    const { 
        ...
        resultsScreenData,
        beatmapPpData,
    } = service.getServices(["settings", "bassDensityData", "allTimesData", "menuData", "gamePlayData", "resultsScreenData", "beatmapPpData"])
    ...
    return {
        ...
        gameplay: {
            ...
            score: (gamePlayData.Mods & OsuMods.ScoreV2) === OsuMods.ScoreV2 ? gamePlayData.ScoreV2 : gamePlayData.Score,
            ...
            leaderboard: {
                ...
                isVisible: gamePlayData.Leaderboard ? gamePlayData.Leaderboard.isScoreboardVisible : false,
                ourplayer: gamePlayData.Leaderboard && gamePlayData.Leaderboard.player ? convertMemoryPlayerToResult(gamePlayData.Leaderboard.player) : defaultLBPlayer,
                slots: gamePlayData.Leaderboard ? gamePlayData.Leaderboard.leaderBoard.map(slot => convertMemoryPlayerToResult(slot)) : []
            }
        },
        resultsScreen: {
