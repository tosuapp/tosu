...
export const lazerOffsets = {
    'osu.Game.OsuGame': {
        osuLogo: 1592,
        ScreenStack: 1536,
        '<frameworkConfig>k__BackingField': 1464
    },
    'osu.Framework.Game': {
        '<Host>k__BackingField': 824
    },
    ...
    'osu.Game.Screens.OsuScreen': {
        '<logo>k__BackingField': 896
    },
    'osu.Game.Screens.Ranking.SoloResultsScreen': {
        '<api>k__BackingField': 1040,
        SelectedScore: 920
    },
    ...
    'osu.Game.Screens.Play.Player': {
        ...
        '<ScoreProcessor>k__BackingField': 1096,
        '<HealthProcessor>k__BackingField': 1104,
    ...
    'osu.Game.Online.Chat.ExternalLinkOpener': {
        '<api>k__BackingField': 536
    },
    'osu.Game.Online.API.APIAccess': {
        '<localUser>k__BackingField': 592,
        game: 504
    },
    ...
    'osu.Game.Scoring.ScoreInfo': {
        '<OnlineID>k__BackingField': 184,
        '<LegacyOnlineID>k__BackingField': 192,
        '<ModsJson>k__BackingField': 80,
        '<HitEvents>k__BackingField': 120,
        '<RealmUser>k__BackingField': 72,
        '<TotalScore>k__BackingField': 160,
        '<MaxCombo>k__BackingField': 204,
        '<Combo>k__BackingField': 212,
        '<Passed>k__BackingField': 220,
        '<Ruleset>k__BackingField': 48,
    ...
    'osu.Framework.Platform.Storage': {
        '<BasePath>k__BackingField': 8
    },
    'osu.Game.IO.WrappedStorage': {
        '<UnderlyingStorage>k__BackingField': 16
    },
    ...
    'osu.Game.Models.RealmUser': {
        '<Username>k__BackingField': 24,
        '<OnlineID>k__BackingField': 40
    },
    'osu.Game.Rulesets.RulesetInfo': {
        '<OnlineID>k__BackingField': 48
    },
    ...
    'osu.Game.Screens.Play.HUDOverlay': {
        InputCountController: 840
    },
    'osu.Game.Screens.Play.HUD.InputCountController': {
        triggers: 512
    },
    'osu.Game.Rulesets.UI.DrawableRuleset': {
        '<ReplayScore>k__BackingField': 808
    },
    'osu.Game.Beatmaps.BeatmapInfo': {
        '<OnlineID>k__BackingField': 140,
        '<MD5Hash>k__BackingField': 88,
        '<StatusInt>k__BackingField': 136,
        '<Metadata>k__BackingField': 48,
        '<Difficulty>k__BackingField': 40,
        '<DifficultyName>k__BackingField': 24,
        '<TotalObjectCount>k__BackingField': 148,
        '<Hash>k__BackingField': 80
    },
    'osu.Game.Beatmaps.BeatmapSetInfo': {
        '<OnlineID>k__BackingField': 48
    },
    'osu.Game.Beatmaps.BeatmapMetadata': {
        '<Title>k__BackingField': 24,
        '<TitleUnicode>k__BackingField': 32,
        '<Artist>k__BackingField': 40,
        '<ArtistUnicode>k__BackingField': 48,
        '<Author>k__BackingField': 56,
        '<Source>k__BackingField': 64,
        '<Tags>k__BackingField': 72,
        '<UserTags>k__BackingField': 80,
        '<PreviewTime>k__BackingField': 104,
        '<AudioFile>k__BackingField': 88,
        '<BackgroundFile>k__BackingField': 96
    },
    'osu.Game.Beatmaps.BeatmapDifficulty': {
        '<DrainRate>k__BackingField': 40,
        '<CircleSize>k__BackingField': 44,
        '<OverallDifficulty>k__BackingField': 48,
        '<ApproachRate>k__BackingField': 52,
        '<SliderMultiplier>k__BackingField': 24,
        '<SliderTickRate>k__BackingField': 32
    },
    'osu.Game.Online.Multiplayer.MultiplayerRoomUser': {
        UserID: 40,
        '<State>k__BackingField': 44,
        '<BeatmapAvailability>k__BackingField': 8,
        '<Mods>k__BackingField': 16,
        '<MatchState>k__BackingField': 24,
        RulesetId: 48,
        BeatmapId: 56,
        '<User>k__BackingField': 32
    },
    'osu.Game.Skinning.SkinManager': {
        CurrentSkin: 80
    },
    'osu.Game.Skinning.Skin': {
        '<Name>k__BackingField': 64
    },
    'osu.Framework.Platform.GameHost': {
        '<inputConfig>k__BackingField': 48
    },
    'osu.Framework.Configuration.InputConfigManager': {
        '<InputHandlers>k__BackingField': 32
    },
    'osu.Framework.Input.Handlers.Tablet.OpenTabletDriverHandler': {
        '<AreaOffset>k__BackingField': 72,
        '<AreaSize>k__BackingField': 80,
        '<Rotation>k__BackingField': 88,
        '<PressureThreshold>k__BackingField': 96
    },
