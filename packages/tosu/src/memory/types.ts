...
export type OffsetKeys =
    | 'gameOsuLogo'
    | 'gameScreenStack'
    | 'gameApiBackingField'
    | 'gameSpectatorBackingField'
    | 'gameScoreManagerBackingField'
    | 'gameMultiplayerClientBackingField'
    | 'gameBeatmapClock'
    | 'gameStorage'
    | 'gameCurrentBeatmap'
    | 'gameOsuLocalConfig'
    | 'gameRulesetConfigCache'
    | 'gameRealmBackingField'
    | 'songSelectV2'
    | 'playerApiBackingField'
    | 'playerSpectatorBackingField'
    | 'playerLoaderOsuLogo'
    | 'replayApiBackingField'
    | 'replayScoreManagerBackingField'
    | 'resultScreenApiBackingField'
    | 'songSelectGameBackingField'
    | 'editorRealmBackingField'
    | 'editorApiBackingField'
    | 'multiSelectApiBackingField'
    | 'logoBackingField'
    | 'multiplayerIsConnectedBindable'
    | 'multiplayerIsConnected'
    | 'multiplayerCurrentRoom'
    | 'multiSelectClientBackingField'
    | 'multiSpectatorBackingField'
    | 'multiplayerClientBackingField'
    | 'currentScreenStack'
    | 'currentScreenCount'
    | 'currentScreenItems'
    | 'configStore'
...
export type LazerOffsets = Record<OffsetKeys, number>;
